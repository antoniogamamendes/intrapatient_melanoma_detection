...
class Resnet18_UNet(nn.Module):
    def __init__(self, n_channels):
        ...
        #self.my_model = torch.load(f"C:\\Users\\AntonioM\\Desktop\\resnet18\\es_model.pth")
        #self.base_model.load_state_dict(self.my_model)
        ...
        self.layer4_1x1 = convrelu(512, 512, 7, 0)

        self.upsample_7 = nn.Upsample(scale_factor=7*2, mode='bilinear', align_corners=True)
